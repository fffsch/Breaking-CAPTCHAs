...
# model = YOLO('runs/detect/masked_training/weights/best.pt') #V3 - New masking preprocessing
model = YOLO('runs/detect/masked_training_11s3/weights/best.pt') #V3 - New masking preprocessing
